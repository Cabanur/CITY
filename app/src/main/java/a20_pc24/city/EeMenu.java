...
//        records = new Rect(ancho2*7,alto*4,ancho2*9,alto*6);
        ...
        this.imgParallax0 = new _ParallaxBm(         //Fondo cielo
                _Utiles.getBitmapFromAsset("parallax/parallax0.png"),0.1f, 0,0,false);
        this.imgParallax2 = new _ParallaxBm(         //Fondo llanuras
                _Utiles.getBitmapFromAsset("parallax/parallax2.png"),0.25f, 0,0, false);
        this.imgParallax3 = new _ParallaxBm(         //Edificios claros
                _Utiles.getBitmapFromAsset("parallax/parallax3.png"),0.35f, 0,0,false);
        this.imgParallax4 = new _ParallaxBm(         //Edificios oscuros
                _Utiles.getBitmapFromAsset("parallax/parallax4.png"),0.75f, 0,0, false);
        this.imgParallax5 = new _ParallaxBm(         //Farolas y calle
                _Utiles.getBitmapFromAsset("parallax/parallax5.png"),1.25f, 0,0, false);
